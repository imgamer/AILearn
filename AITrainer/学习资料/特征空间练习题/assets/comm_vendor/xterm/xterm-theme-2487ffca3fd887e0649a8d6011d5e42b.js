...
!function(a, b) {
    "object" == typeof exports && "undefined" != typeof module ? b(exports) : "function" == typeof define && define.amd ? define(["exports"], b) : b((a = a || self).xtermTheme = {})
}(this, function(a) {
    var b = {
        foreground: "#a5a2a2",
        background: "#090300",
      ...
      , ec = {
        ...
        Japanesque: ra,
        Jellybeans: sa,
        JetBrains_Darcula: ta,
        Kibble: ua,
        Later_This_Evening: va,
        Lavandula: wa,
        LiquidCarbon: xa,
        LiquidCarbonTransparent: ya,
        LiquidCarbonTransparentInverse: za,
        Man_Page: Aa,
        Material: Ba,
        MaterialDark: Ca,
        Mathias: Da,
        ...
        Smyck: ob,
        SoftServer: pb,
        Solarized_Darcula: qb,
        Solarized_Dark: rb,
        Solarized_Dark_Patched: sb,
        Solarized_Dark_Higher_Contrast: tb,
        Solarized_Light: ub,
        SpaceGray: vb,
        SpaceGray_Eighties: wb,
        SpaceGray_Eighties_Dull: xb,
        Spacedust: yb,
        Spiderman: zb,
        Spring: Ab,
        Square: Bb,
        ...
        Tomorrow: Ib,
        Tomorrow_Night: Jb,
        Tomorrow_Night_Blue: Kb,
        Tomorrow_Night_Bright: Lb,
        Tomorrow_Night_Eighties: Mb,
        ToyChest: Nb,
        Treehouse: Ob,
        Ubuntu: Pb,
        UnderTheSea: Qb,
    ...
    a.Japanesque = ra;
    a.Jellybeans = sa;
    a.JetBrains_Darcula = ta;
    a.Kibble = ua;
    a.Later_This_Evening = va;
    a.Lavandula = wa;
    a.LiquidCarbon = xa;
    a.LiquidCarbonTransparent = ya;
    a.LiquidCarbonTransparentInverse = za;
    a.Man_Page = Aa;
    a.Material = Ba;
    a.MaterialDark = Ca;
    a.Mathias = Da;
    ...
    a.Smyck = ob;
    a.SoftServer = pb;
    a.Solarized_Darcula = qb;
    a.Solarized_Dark = rb;
    a.Solarized_Dark_Higher_Contrast = tb;
    a.Solarized_Dark_Patched = sb;
    a.Solarized_Light = ub;
    a.SpaceGray = vb;
    a.SpaceGray_Eighties = wb;
    a.SpaceGray_Eighties_Dull = xb;
    a.Spacedust = yb;
    a.Spiderman = zb;
    a.Spring = Ab;
    a.Square = Bb;
    ...
    a.Tomorrow = Ib;
    a.Tomorrow_Night = Jb;
    a.Tomorrow_Night_Blue = Kb;
    a.Tomorrow_Night_Bright = Lb;
    a.Tomorrow_Night_Eighties = Mb;
    a.ToyChest = Nb;
    a.Treehouse = Ob;
    a.Ubuntu = Pb;
    a.UnderTheSea = Qb;
